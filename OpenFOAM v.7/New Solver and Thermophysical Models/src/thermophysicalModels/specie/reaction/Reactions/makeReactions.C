...
namespace Foam
{
    ...
    // Keivan:
    // Adding a new reaction based on sensible internal energy and non-ideal EOS
	//1:
    makeReactions(nonIdealGasEThermoPhysics, nonIdealGasEReaction)
	//2:
	makeReactions(nasaPolyPengRobinsonGasEThermoPhysics, nasaPolyPengRobinsonGasEReaction)
}
