...
// Keivan:
// Declaring the new thermopyhicalModel based on NASA polynamial coefficient and PengRobinson EOS
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
// Keivan:
// Testing new thermophysical models based on non-ideal EOS
//1:
makeReactionThermos
(
    psiThermo,
