...
// Keivan:
// Adding new chemistry readers for the new thermophysical models
makeChemistryReader(nonIdealGasEThermoPhysics);
makeChemistryReader(nasaPolyPengRobinsonGasEThermoPhysics);

makeChemistryReaderType(foamChemistryReader, nonIdealGasEThermoPhysics);
makeChemistryReaderType(foamChemistryReader, nasaPolyPengRobinsonGasEThermoPhysics);
//
